                                   ...
                                   <div className="card">
                                        ...
                                        <div className="comment-widgets scrollable">
                                             ...
                                             <div className="d-flex flex-row comment-row mt-0">
                                                  <div className="p-2">
                                                       <img src="/admin/assets/images/users/1.jpg" alt="user" width={50} className="rounded-circle" />
                                                  </div>
                                                  <div className="comment-text w-100">
                                                       ...
                                                       <div className="comment-footer">
                                                            ...
                                                            <button type="button" className="btn btn-cyan btn-sm text-white">
                                                                 Edit
                                                            </button>
                                             ...
                                             <div className="d-flex flex-row comment-row">
                                                  <div className="p-2">
                                                       <img src="/admin/assets/images/users/4.jpg" alt="user" width={50} className="rounded-circle" />
                                                  </div>
                                             ...
                                             <div className="d-flex flex-row comment-row">
                                                  <div className="p-2">
                                                       <img src="/admin/assets/images/users/5.jpg" alt="user" width={50} className="rounded-circle" />
                                                  </div>
                                                  <div className="comment-text w-100">
                                                       ...
                                                       <li className="list-group-item todo-item" data-role="task">
                                                            <div className="form-check">
                                                                 ...
                                                                 <label className="form-check-label w-100 mb-0 todo-label" htmlFor="customCheck">
                                                                      <span className="todo-desc fw-normal">Lorem Ipsum is simply dummy text of the printing
                                                                           and typesetting industry.</span>
                                                                      <span className="badge rounded-pill bg-danger float-end">Today</span>
                                                                 </label>
                                                            </div>
                                                            <ul className="list-style-none assignedto">
                                                                 <li className="assignee">
                                                                      <img className="rounded-circle" width={40} src="/admin/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title data-original-title="Steave" />
                                                                 </li>
                                                                 <li className="assignee">
                                                                      <img className="rounded-circle" width={40} src="/admin/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title data-original-title="Jessica" />
                                                                 </li>
                                                                 <li className="assignee">
                                                                      <img className="rounded-circle" width={40} src="/admin/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title data-original-title="Priyanka" />
                                                                 </li>
                                                                 <li className="assignee">
                                                                      <img className="rounded-circle" width={40} src="/admin/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title data-original-title="Selina" />
                                                                 </li>
                                                            </ul>
                                                       </li>
                                                       <li className="list-group-item todo-item" data-role="task">
                                                       ...
                                                       <li className="list-group-item todo-item" data-role="task">
                                                            <div className="form-check">
                                                                 ...
                                                                 <label className="form-check-label w-100 mb-0 todo-label" htmlFor="customCheck2">
                                                                      <span className="todo-desc fw-normal">Give Purchase report to</span>
                                                                      <span className="badge rounded-pill bg-info float-end">Yesterday</span>
                                                                 </label>
                                                            </div>
                                                            <ul className="list-style-none assignedto">
                                                                 <li className="assignee">
                                                       ...
                                                       <li className="list-group-item todo-item" data-role="task">
                                                            <div className="form-check">
                                                                 ...
                                                                 <label className="form-check-label w-100 mb-0 todo-label" htmlFor="customCheck3">
                                                                      ...
                                                                      <span className="badge rounded-pill bg-warning float-end">2 weeks</span>
                                                                 </label>
                                                            </div>
                                                            <div className="item-date">26 jun 2021</div>
                                                       </li>
                              ...
                              <div className="col-lg-6">
                                   ...
                                   <div className="card">
                                        <div className="card-body">
                                             ...
                                             <div className="chat-box scrollable" style={{ height: '475px' }}>
                                                  {/*chat Row */}
                                        ...
                                        <div className="card-body border-top">
                                             <div className="row">
                                                  ...
                                                  <div className="col-3">
                                                       <a className="btn-circle btn-lg btn-cyan float-end text-white" href="javascript:void(0)"><i className="mdi mdi-send fs-3" /></a>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div className="card">
                                        ...
                                        <div className="comment-widgets scrollable" style={{ maxHeight: '130px' }}>
                                             {/* Comment Row */}
                                             <div className="d-flex flex-row comment-row mt-0">
                                                  <div className="p-2">
                                                       <img src="/admin/assets/images/users/1.jpg" alt="user" width={50} className="rounded-circle" />
                                   ...
                                   <div className="accordion" id="accordionExample">
                                        <div className="card mb-0">
                                             <div className="card-header" id="headingOne">
                                                  <h5 className="mb-0">
                                                       <a className="d-flex align-items-center" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                            <i className="me-1 mdi mdi-magnet fs-4" aria-hidden="true" />
                                        ...
                                        <div className="card mb-0 border-top">
                                             <div className="card-header" id="headingTwo">
                                                  <h5 className="mb-0">
                                                       <a className="collapsed d-flex align-items-center" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                            <i className="me-1 mdi mdi-magnet fs-4" aria-hidden="true" />
                                        ...
                                        <div className="card mb-0 border-top">
                                             <div className="card-header" id="headingThree">
                                                  <h5 className="mb-0">
                                                       <a className="collapsed d-flex align-items-center" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                            <i className="me-1 mdi mdi-magnet fs-4" aria-hidden="true" />
                                   ...
                                   <div id="accordian-4">
                                        <div className="card mt-4">
                                             <a className="card-header link" data-toggle="collapse" data-parent="#accordian-4" href="#Toggle-1" aria-expanded="true" aria-controls="Toggle-1">
                                                  <i className="seticon mdi mdi-arrow-right-bold" aria-hidden="true" />
                                   ...
                                   <div className="card">
                                        ...
                                        <ul className="nav nav-tabs" role="tablist">
                                             <li className="nav-item">
                                                  <a className="nav-link active" data-bs-toggle="tab" href="#home" role="tab"><span className="hidden-sm-up" />
                                                       <span className="hidden-xs-down">Tab1</span></a>
                                             </li>
                                             <li className="nav-item">
                                                  <a className="nav-link" data-bs-toggle="tab" href="#profile" role="tab"><span className="hidden-sm-up" />
                                                       <span className="hidden-xs-down">Tab2</span></a>
                                             </li>
                                             <li className="nav-item">
                                                  <a className="nav-link" data-bs-toggle="tab" href="#messages" role="tab"><span className="hidden-sm-up" />
                                        ...
                                        <div className="tab-content tabcontent-border">
                                             <div className="tab-pane active" id="home" role="tabpanel">
                                                  <div className="p-20">
                                                       ...
                                                       <img src="/admin/assets/images/background/img4.jpg" className="img-fluid" />
                                                  </div>
                                             </div>
